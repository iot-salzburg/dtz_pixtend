...
TestVar = Param.add_variable(addspace, "TestVar", 0)
...
# Start the server
server.start()
print("Server startet ad {}".format(url))
...
try:
	...
	TestVariable = 124 
        ...
        print(Temperature, Pressure, TIME, TestVariable)
        Temp.set_value(Temperature)
        Press.set_value(Pressure)
        Time.set_value(TIME)
        TestVar.set_value(TestVariable)
        # sleep 2 seconds
        time.sleep(2)
finally:
